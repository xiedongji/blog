<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\phpStudy\WWW\blog\public/../apps/mgr\view\menu\index.html";i:1482996877;s:54:"D:\phpStudy\WWW\blog\public/../apps/mgr\view\base.html";i:1481076134;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('mgr/menu/add'); ?>">添加菜单</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <a href="<?php echo url('mgr/menu/indexRoot'); ?>" class="layui-btn layui-btn-small">只显示一级菜单</a>
                <table class="layui-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i
                                <$vo[ 'level'];$i++){echo ' ----';} endif; ?> <?php echo $vo['title']; ?></td>
                                    <td><?php echo $vo['name']; ?></td>
                                    <td><?php echo $vo['status']==1 ? '显示' : '隐藏'; ?></td>
                                    <td>
                                        <a href="<?php echo url('mgr/menu/add',['pid'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini">添加子菜单</a>
                                        <a href="<?php echo url('mgr/menu/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                                        <a href="<?php echo url('mgr/menu/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                                    </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
